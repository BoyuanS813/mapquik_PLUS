...
time ./mm2-fast --secondary no -t 10 -x map-pb $REF $READS> mm2-fast.real.CLR.paf
awk '$12 == 60 {print}' mm2-fast.real.CLR.paf | wc -l
time blend --secondary no -t 10 -x map-pb $REF $READS> blend.real.CLR.paf
awk '$12 == 60 {print}' blend.real.CLR.paf | wc -l
time winnowmap -W repetitive_k15.txt --secondary no -t 10 -x map-pb $REF $READS> winnowmap.real.CLR.paf
